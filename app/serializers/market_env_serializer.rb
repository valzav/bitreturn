class MarketEnvSerializer < ActiveModel::Serializer
  attributes :id, :monthly_growth, :investment_horizon, :data_hashes,
             :data_difficulty, :data_f_hashes, :data_f_difficulty,
             :cur_speed, :cur_difficulty, :usd_btc_rate, :power_cost, :pool_fee
